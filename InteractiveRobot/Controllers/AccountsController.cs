    ...
    public class AccountsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(RegisterRequest registerRequest)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if(registerRequest.ApplicationUserType == ApplicationUserType.Parent)
                {
                    await _userManager.AddToRoleAsync(applicationUser, SD.Parent);
                } else if(registerRequest.ApplicationUserType == ApplicationUserType.Doctor)
                {
                    await _userManager.AddToRoleAsync(applicationUser, SD.Doctor);
                }
